...
Endpoint.prototype.run = function(headers, body, context){
  ...
  //Context is information about an endpoint instance's 
  //usage that it may want or need. For example, it is given details
  //about the remote request made (e.g. if the endpoint needs the
  //hostname/path requested to do href resolving)
  
  this._run(headers, body, context);
};
